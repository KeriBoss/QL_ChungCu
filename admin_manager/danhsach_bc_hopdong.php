                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="parent">
                            <div class="form-group">
                                ...
                                <label for="bao_cao1">Danh sách các hợp đồng chính thức</label>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="form-group mt-3">
                            ...
                            <div id="type_print" class="group-flex">
                                <!-- <div>
                                    <input type="radio" name="dinh_dang" id="dinh_dang1" value="pdf" checked>
                                    <label for="dinh_dang1">Tệp tin (.pdf)</label>
                                </div> -->
                                <div>
                                    <input type="radio" name="dinh_dang" id="dinh_dang2" value="xls">
                                    <label for="dinh_dang2">Tệp tin excel(.xls)</label>
                                </div>
                                <div>
                                    <input type="radio" name="dinh_dang" id="dinh_dang3" value="doc">
                                    <label for="dinh_dang3">Tệp tin word(.doc)</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="button" onclick="exportHTML()" class="btn btn-primary">Xuất</button>
                </form>
            </div>
        </div>
    </div>
