...
if(isset($_POST['type_hopdong']) && isset($_POST['so_hd']) && isset($_POST['ten_bophan']) && isset($_POST['nha_moigioi']) && isset($_POST['tien_moigioi']) && isset($_POST['ngay_lap']) && isset($_POST['ngay_giaodat']) && isset($_POST['ngay_giaoso']) && isset($_POST['id_duan']) && isset($_POST['nendat_id']) && isset($_POST['gia_dat']) && isset($_POST['gia_hopdong']) && isset($_POST['dientich_hd']) && isset($_POST['giadat_usd']) && isset($_POST['gia_thucte']) && isset($_POST['dientich_thucte']) && isset($_POST['id_khachhang']) && isset($_POST['thanhtoan']) && isset($_POST['id_giaidoan']) && isset($_POST['ten_giaidoan']) && isset($_POST['tien_hd']) && isset($_POST['ngay_tratien']) && isset($_POST['id_hopdong'])){
    ...
    $id_giaidoan = $_POST['id_giaidoan'];
    $ten_giaidoan = $_POST['ten_giaidoan'];
    $tien_hd = $_POST['tien_hd'];
