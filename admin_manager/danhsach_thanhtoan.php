                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_hopdong_thanhtoan.php?id_hd=<?=$id_hd?>&id_thanhtoan=<?=$item['id']?>" class="icon edit"><i class='bx bx-edit'></i></a>
                                                    <a href="action/xoa_hopdong_thanhtoan.php?id_hd=<?=$id_hd?>&id_thanhtoan=<?=$item['id']?>" onclick="if(CheckForm() == false) return false;" class="icon delete"><i class='bx bxs-message-square-x' ></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mt-3 align-items-center">
                                    ...
                                    <div class="col-lg-5 col-md-7 col-7">
                                        <input type="number" class="form-control" name="tien_thanhly" min="1000000" max="100000000000" step="1" placeholder="> 1.000.000 và < 1.000.000.000.000">
                                    </div>
